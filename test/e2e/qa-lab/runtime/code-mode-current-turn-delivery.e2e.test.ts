    ...
    it(
      ...
      async () => {
        ...
        for (const [index, turn] of turns.entries()) {
          ...
          if (typeof plannedToolCallId !== "string" || typeof plannedCode !== "string") {
          ...
          const completion = await waitFor(
            ...
            async () => {
              ...
              if (observed.status === "pending") {
                completionDiagnostic = observed.reason;
                return undefined;
              }
              return observed;
            },
          ...
          expect(settled.requests[index]?.plannedToolCallId).toBe(completion.toolCallId);
